// Initialize Firebase
var config = {
  apiKey: "AIzaSyCJ-jJKsiMct3dADglHvkUBNnIIjv3xXK8",
  authDomain: "contactlist-1d840.firebaseapp.com",
  databaseURL: "https://contactlist-1d840.firebaseio.com",
  storageBucket: "contactlist-1d840.appspot.com",
  messagingSenderId: "341708973872"
};
...
function submitEmail(email) {
  return new Promise((res, rej) => {
    const ref = db.ref('contacts').push(email);
    if (ref) {
      res(ref.key);
    } else {
      rej('Write to ref failed');
    }
  });
}
        ...
        submitEmail(email)
          .then(function(data){
              ...
              console.log('data:', data);
				...
				// jQuery.post(this.action,{
				// 	'email':$('input[name="b_email"]').val(),
        //   'u': '208c3c43f4e6086ba009f74c3',
        //   'id': '6138f98283',
				// },function(data){
				// 	form.fadeOut('fast', function() {
        //     console.log('data:', data);
